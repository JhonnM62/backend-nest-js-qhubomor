...
export class UpdateTurnoAdminDto {
  ...
  @IsOptional()
  @IsString()
  @IsIn(['ACTIVO', 'COMPLETADO', 'FINALIZADO', 'ANULADO', 'LIQUIDADO'])
  estado?: string;
...
export class TurnosQueryDto {
  ...
  @IsOptional()
  @IsString()
  @IsIn(['ACTIVO', 'COMPLETADO', 'ANULADO', 'LIQUIDADO'])
  estado?: string;
...
const CONCEPTOS_VALIDOS = ['DESCUADRE_CAJA', 'CENA', 'PERDIDA', 'ROBO', 'ADELANTO', 'LLEGADA_TARDIA', 'BONO', 'PREMIO', 'HORAS_EXTRAS', 'OTRO'];
